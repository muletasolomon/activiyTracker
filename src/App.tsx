...
function App() {
    ...
    const selectedProjectId=useAppSelector(s=>s.taskActivity.selectedProjectId);
    ...
    const removeActivity = () => {
        ...
        let data = async () => await fetch("http://196.189.53.130:20998/testApi/rest/registrationResource/deleteActivity?activityId=" + taskParentNode, {
    ...
    const removeSubActivity = () => {
        ...
        let data = async () => await fetch("http://196.189.53.130:20998/testApi/rest/registrationResource/deleteSubActivity?activityId=" + taskParentNode, {
    ...
    const workList = () => {
        console.log("ty");
        let dataSample = []
        let data = async () => await fetch(`http://196.189.53.130:20998/testApi/rest/subactivities/getActivityList?projectId=${selectedProjectId}`, {
            ...
            pro.map(element => {
                ...
                data.push({
                    key: element.id,
                    data: {name: element.name, budget: element.description, isActivity: true},
                    children: [...element.subActivityList.map(subactiv => {
                        console.log('subactiv', subactiv)
                        return ({
                            key: subactiv.id,
                            data: {name: subactiv.name, budget: subactiv.projectBudjet, isActivity: false}
                        })
                    })]
                })
